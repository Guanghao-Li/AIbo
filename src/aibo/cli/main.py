...
from aibo.cli.commands.chat import cmd_chat
from aibo.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from aibo.cli.commands.ping import cmd_ping
from aibo.cli.commands.run import cmd_run
from aibo.cli.commands.trace import cmd_trace
from aibo.cli.commands.version import cmd_version
from aibo.core.config import get_config
from aibo.core.logging_setup import setup_logging


# CLI 主入口：解析命令行参数并分发到对应子命令
def main() -> None:
    parser = argparse.ArgumentParser(prog="aibo", description="AIBO CLI")
