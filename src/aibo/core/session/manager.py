...
from aibo.core.bus.envelope import HandlerError
from aibo.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from aibo.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from aibo.core.bus.commands import SessionCompactResult
